      ...
      <div className="relative mx-auto w-full max-w-6xl px-6">
        ...
        >
          <span className="glass inline-flex items-center gap-2 rounded-full px-3.5 py-1.5 text-[12px] font-medium text-foreground/80">
            ...
            <span className="text-mono-data uppercase tracking-[0.14em]">
              Offline-first · Built for Bharat
            </span>
          </span>
        </motion.div>
        ...
        <motion.div variants={stagger} initial="hidden" animate="show" className="text-center">
          <motion.h1
            variants={rise}
            className="text-display text-balance text-[clamp(2.6rem,7vw,5.8rem)]"
          >
            Rural infrastructure
            <br />
            should never wait for{" "}
            <span className="text-accent-script text-accent text-[1.18em] leading-[0.7] -mr-2">
              signal
            </span>
            .
          </motion.h1>
          ...
          >
            SevaJyothi is the offline-first infrastructure intelligence layer for villages operating
            beyond the network edge. Report transformer failures, pipe bursts and road damage from
            anywhere — we sync the moment signal returns.
          </motion.p>
          ...
          <motion.div
            variants={rise}
            className="mt-8 flex items-center justify-center gap-6 text-[12px] text-muted-foreground"
          >
  ...
  return (
    <span className="inline-flex items-center gap-2">
      <span className="relative inline-flex h-2 w-2">
        <span
          className="absolute inset-0 rounded-full animate-sj-pulse-ring"
