  ...
  return (
    <article className="mx-auto max-w-3xl px-6 pt-32 pb-24">
      ...
      <p className="mt-3 text-[15px] text-muted-foreground">
        Every dashboard subscribes to Postgres changes through Supabase Realtime. When a complaint
        moves, the citizen, the authority and the technician all see the new state inside a single
        repaint.
      </p>
      <div className="mt-10 grid gap-4">
        ...
        <Block
          icon={Map}
          title="Roadmap — geospatial fabric"
