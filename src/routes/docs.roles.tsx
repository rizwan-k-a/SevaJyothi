  ...
  return (
    <article className="mx-auto max-w-3xl px-6 pt-32 pb-24">
      ...
      <p className="mt-3 text-[15px] text-muted-foreground">
        Roles are stored in <code className="text-mono-data">public.user_roles</code> and checked
        through the SECURITY-DEFINER <code className="text-mono-data">has_role()</code> function —
        never via JWT claims, to avoid privilege escalation.
      </p>
